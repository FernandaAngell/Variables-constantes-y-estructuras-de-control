...
Clasificación del consumo mensual en kWh (bajo, medio, alto) y cálculo del valor a pagar, aplicando descuentos o recargos.
...
## 🎯 Objetivo  
Fortalecer habilidades en lógica de programación mediante la resolución de problemas prácticos, aplicando estructuras de control y buenas prácticas.
